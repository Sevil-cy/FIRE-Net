...
from models.network_firenet import FIRENet as net
...
def main():
    ...
    parser.add_argument('--scale', type=int, default=1, help='scale factor: 2, 4') # 1 for dn and jpeg car
    parser.add_argument('--noise', type=int, default=15, help='noise level: 15, 25, 50')
    parser.add_argument('--jpeg', type=int, default=40, help='scale factor: 10, 20, 30, 40')
    parser.add_argument('--training_patch_size', type=int, default=128, help='patch size used in training.')
    ...
    for idx, path in enumerate(sorted(glob.glob(os.path.join(folder, '*')))):
        ...
        cv2.imwrite(f'{save_dir}/{imgname}_FIRENet.png', output)
...
def setup(args):
    ...
    if args.task in ['classical_sr']:
        save_dir = f'results/firenet_{args.task}_x{args.scale}'
